...
if( !class_exists( 'VaathiPlusFooterElementor' ) ) {
    class VaathiPlusFooterElementor {
        ...
        function frontend() {
            add_filter( 'vaathi_print_footer_template', array( $this, 'register_footer_template' ), 10, 1 );
        }
		...
		function register_footer_template( $id ) {
            ...
            return apply_filters( 'vaathi_plus_footer_content', $content );
		}
    }
}

VaathiPlusFooterElementor::instance();