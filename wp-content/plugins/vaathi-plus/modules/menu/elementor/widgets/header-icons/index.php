...
if( !class_exists( 'VaathiPlusHeaderIconsWidget' ) ) {
    class VaathiPlusHeaderIconsWidget {
        ...
        function register_widgets( $widgets_manager ) {
            require VAATHI_PLUS_DIR_PATH. 'modules/menu/elementor/widgets/header-icons/class-widget-header-icons.php';
            $widgets_manager->register( new \Elementor_Header_Icons() );
        }

        function register_widget_styles() {
            wp_register_style( 'wdt-header-icons',
                VAATHI_PLUS_DIR_URL . 'modules/menu/elementor/widgets/assets/css/header-icons.css', array(), VAATHI_PLUS_VERSION );

            if( function_exists( 'is_woocommerce' ) ) {
                wp_register_style( 'wdt-header-carticons',
                    VAATHI_PLUS_DIR_URL . 'modules/menu/elementor/widgets/assets/css/header-carticon.css', array(), VAATHI_PLUS_VERSION );
            }
        }

        function register_widget_scripts() {
            wp_register_script( 'jquery-nicescroll',
                VAATHI_PLUS_DIR_URL . 'modules/menu/elementor/widgets/assets/js/jquery.nicescroll.js', array(), VAATHI_PLUS_VERSION, true );
            wp_register_script( 'wdt-header-icons',
                VAATHI_PLUS_DIR_URL . 'modules/menu/elementor/widgets/assets/js/header-icons.js', array(), VAATHI_PLUS_VERSION, true );
        }
...
VaathiPlusHeaderIconsWidget::instance();
