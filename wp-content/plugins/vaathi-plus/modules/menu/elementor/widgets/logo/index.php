...
if( !class_exists( 'VaathiPlusLogoWidget' ) ) {
    class VaathiPlusLogoWidget {
        ...
        function register_widgets( $widgets_manager ) {
            require VAATHI_PLUS_DIR_PATH. 'modules/menu/elementor/widgets/logo/class-widget-logo.php';
            $widgets_manager->register( new \Elementor_logo() );
        }

        function register_widget_styles() {
            wp_register_style( 'wdt-logo',
                VAATHI_PLUS_DIR_URL . 'modules/menu/elementor/widgets/assets/css/logo.css', array(), VAATHI_PLUS_VERSION );
        }
