...
if( !class_exists( 'VaathiPlusCustomizerSiteTitle' ) ) {
    class VaathiPlusCustomizerSiteTitle {
        ...
        function register( $wp_customize ) {
            ...
            $wp_customize->add_section(
                new Vaathi_Customize_Section(
                    ...
                    'site-title-section',
                    array(
                        'title'    => esc_html__('Site Title', 'vaathi-plus'),
            ...
            if ( ! defined( 'VAATHI_PRO_VERSION' ) ) {
                $wp_customize->add_control(
                    new Vaathi_Customize_Control_Separator(
                        $wp_customize, VAATHI_CUSTOMISER_VAL . '[vaathi-plus-site-title-separator]',
                        array(
                            'type'        => 'wdt-separator',
...
VaathiPlusCustomizerSiteTitle::instance();