...
if( !class_exists( 'VaathiPlusH3Settings' ) ) {
    class VaathiPlusH3Settings {
        ...
        function __construct() {
            $this->selector = apply_filters( 'vaathi_h3_selector', array( 'h3' ) );
            $this->settings = vaathi_customizer_settings('h3_typo');

            add_filter( 'vaathi_plus_customizer_default', array( $this, 'default' ) );
            add_action( 'customize_register', array( $this, 'register' ), 20);

            add_filter( 'vaathi_h3_typo_customizer_update', array( $this, 'h3_typo_customizer_update' ) );
        ...
        function register( $wp_customize ) {
            ...
            $wp_customize->add_section(
                new Vaathi_Customize_Section(
                    ...
                    'site-h3-section',
                    array(
                        'title'    => esc_html__('H3 Typography', 'vaathi-plus'),
             ...
             */
                $wp_customize->add_setting(
                    VAATHI_CUSTOMISER_VAL . '[h3_typo]', array(
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new Vaathi_Customize_Control_Typography(
                        $wp_customize, VAATHI_CUSTOMISER_VAL . '[h3_typo]', array(
                            'type'    => 'wdt-typography',
                            'section' => 'site-h3-section',
                            'label'   => esc_html__( 'H3 Tag', 'vaathi-plus'),
                        )
                    )
                );
             ...
             */
                $wp_customize->add_setting(
                    VAATHI_CUSTOMISER_VAL . '[h3_color]', array(
                        'default' => '',
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new WP_Customize_Color_Control(
                        $wp_customize, VAATHI_CUSTOMISER_VAL . '[h3_color]', array(
        ...
        function h3_typo_customizer_update( $defaults ) {
            $h3_typo = vaathi_customizer_settings( 'h3_typo' );
            if( !empty( $h3_typo ) ) {
                return  $h3_typo;
            }
            return $defaults;
        ...
        function base_style( $style ) {
            $css   = '';
            $color = vaathi_customizer_settings('h3_color');
