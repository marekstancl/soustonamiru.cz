...
if( !class_exists( 'VaathiPlusH6Settings' ) ) {
    class VaathiPlusH6Settings {
        ...
        function __construct() {
            $this->selector = apply_filters( 'vaathi_h6_selector', array( 'h6' ) );
            $this->settings = vaathi_customizer_settings('h6_typo');

            add_filter( 'vaathi_plus_customizer_default', array( $this, 'default' ) );
            add_action( 'customize_register', array( $this, 'register' ), 20);

            add_filter( 'vaathi_h6_typo_customizer_update', array( $this, 'h6_typo_customizer_update' ) );
        ...
        function register( $wp_customize ) {
            ...
            $wp_customize->add_section(
                new Vaathi_Customize_Section(
                    ...
                    'site-h6-section',
                    array(
                        'title'    => esc_html__('H6 Typography', 'vaathi-plus'),
             ...
             */
                $wp_customize->add_setting(
                    VAATHI_CUSTOMISER_VAL . '[h6_typo]', array(
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new Vaathi_Customize_Control_Typography(
                        $wp_customize, VAATHI_CUSTOMISER_VAL . '[h6_typo]', array(
                            'type'    => 'wdt-typography',
                            'section' => 'site-h6-section',
                            'label'   => esc_html__( 'H6 Tag', 'vaathi-plus'),
                        )
                    )
                );
             ...
             */
                $wp_customize->add_setting(
                    VAATHI_CUSTOMISER_VAL . '[h6_color]', array(
                        'default' => '',
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new WP_Customize_Color_Control(
                        $wp_customize, VAATHI_CUSTOMISER_VAL . '[h6_color]', array(
        ...
        function h6_typo_customizer_update( $defaults ) {
            $h6_typo = vaathi_customizer_settings( 'h6_typo' );
            if( !empty( $h6_typo ) ) {
                return  $h6_typo;
            }
            return $defaults;
        ...
        function base_style( $style ) {
            $css   = '';
            $color = vaathi_customizer_settings('h6_color');
