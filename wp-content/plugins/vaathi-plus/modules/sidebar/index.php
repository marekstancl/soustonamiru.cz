...
if( !class_exists( 'VaathiPlusSidebar' ) ) {
    class VaathiPlusSidebar {
        ...
        function load_modules() {
            include_once VAATHI_PLUS_DIR_PATH.'modules/sidebar/customizer/index.php';
        }

        function frontend() {
            add_filter('vaathi_primary_classes', array( $this, 'primary_classes' ), 10 );
            add_filter('vaathi_secondary_classes', array( $this, 'secondary_classes' ), 10 );
        }
