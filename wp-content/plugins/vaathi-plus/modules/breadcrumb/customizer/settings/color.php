...
if( !class_exists( 'VaathiPlusBreadCrumbColor' ) ) {
    class VaathiPlusBreadCrumbColor {
        ...
        function register( $wp_customize ) {
            ...
            $wp_customize->add_section(
                new Vaathi_Customize_Section(
                    ...
                    array(
                        'title'    => esc_html__('Colors & Background', 'vaathi-plus'),
            ...
            if ( ! defined( 'VAATHI_PRO_VERSION' ) ) {
                $wp_customize->add_control(
                    new Vaathi_Customize_Control_Separator(
                        $wp_customize, VAATHI_CUSTOMISER_VAL . '[vaathi-plus-site-breadcrumb-color-separator]',
                        array(
                            'type'        => 'wdt-separator',
...
VaathiPlusBreadCrumbColor::instance();