;(function ( $, window, document, undefined ) {
    'use strict';
    $.VAATHIPLUSWPCUSTOMIZER = $.VAATHIPLUSWPCUSTOMIZER || {};

	$.VAATHIPLUSWPCUSTOMIZER.DEPENDENCY = function( el, param ) {
	...
	$.fn.VAATHIPLUSWPCUSTOMIZER_DEPENDENCY = function ( param ) {
		return this.each(function () {
			new $.VAATHIPLUSWPCUSTOMIZER.DEPENDENCY( this, param );
		});
	};

	$(document).ready( function() {
		$('.wp-customizer').VAATHIPLUSWPCUSTOMIZER_DEPENDENCY();
	});
