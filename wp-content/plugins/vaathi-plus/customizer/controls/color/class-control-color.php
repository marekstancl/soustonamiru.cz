...
class Vaathi_Customize_Control_Color extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'vaathi-plus-color-control', VAATHI_PLUS_DIR_URL.'customizer/controls/color/color.js', array( 'jquery', 'customize-base' , 'vaathi-plus-customizer-color-picker' ), VAATHI_PLUS_VERSION, true );
		wp_enqueue_style( 'vaathi-plus-color-control',  VAATHI_PLUS_DIR_URL.'customizer/controls/color/color.css', null, VAATHI_PLUS_VERSION );
	}
