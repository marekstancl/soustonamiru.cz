...
class Vaathi_Customize_Control_Slider extends WP_Customize_Control {
	...
	*/
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'vaathi-plus-slider-control', VAATHI_PLUS_DIR_URL.'customizer/controls/slider/slider.js', array( 'jquery', 'customize-base' ), VAATHI_PLUS_VERSION, true );
		wp_enqueue_style( 'vaathi-plus-slider-control',  VAATHI_PLUS_DIR_URL.'customizer/controls/slider/slider.css', null, VAATHI_PLUS_VERSION );
	}
