...
class Vaathi_Customize_Control_Fontawesome extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'vaathi-plus-fontawesome-control', VAATHI_PLUS_DIR_URL . 'customizer/controls/fontawesome/fontawesome.js', array( 'jquery', 'customize-base' ), VAATHI_PLUS_VERSION, true );
		wp_enqueue_style( 'vaathi-plus-fontawesome-control',  VAATHI_PLUS_DIR_URL . 'customizer/controls/fontawesome/fontawesome.css', null, VAATHI_PLUS_VERSION );

		wp_enqueue_style( 'vaathi-plus-fontawesome',  VAATHI_PLUS_DIR_URL . 'customizer/assets/css/fontawesome-all.css', array(),VAATHI_PLUS_VERSION, 'all' );
	}
	...
	public function to_json() {
		...
		$this->json['reset'] = esc_html__( "Reset", "vaathi-plus") .' '.esc_html( $this->label );
