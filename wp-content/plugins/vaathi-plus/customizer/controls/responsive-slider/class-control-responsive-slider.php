...
class Vaathi_Customize_Control_Responsive_Slider extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'vaathi-plus-responsive-slider-control', VAATHI_PLUS_DIR_URL . 'customizer/controls/responsive-slider/responsive-slider.js', array( 'jquery', 'customize-base' ), VAATHI_PLUS_VERSION, true );
		wp_enqueue_style( 'vaathi-plus-responsive-slider-control',  VAATHI_PLUS_DIR_URL . 'customizer/controls/responsive-slider/responsive-slider.css', null, VAATHI_PLUS_VERSION );
	}
