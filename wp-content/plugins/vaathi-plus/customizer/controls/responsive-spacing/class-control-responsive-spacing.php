...
class Vaathi_Customize_Control_Responsive_Spacing extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'vaathi-plus-responsive-spacing-control', VAATHI_PLUS_DIR_URL.'customizer/controls/responsive-spacing/responsive-spacing.js', array( 'jquery', 'customize-base' ), VAATHI_PLUS_VERSION, true );
		wp_enqueue_style( 'vaathi-plus-responsive-spacing-control',  VAATHI_PLUS_DIR_URL.'customizer/controls/responsive-spacing/responsive-spacing.css', null, VAATHI_PLUS_VERSION );
	}
