...
class Vaathi_Customize_Control_Description extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'vaathi-plus-description-control',  VAATHI_PLUS_DIR_URL.'customizer/controls/description/description.css', null, VAATHI_PLUS_VERSION );
	}
