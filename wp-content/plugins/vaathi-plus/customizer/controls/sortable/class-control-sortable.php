...
class Vaathi_Customize_Control_Sortable extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'vaathi-plus-sortable-control', VAATHI_PLUS_DIR_URL.'customizer/controls/sortable/sortable.js', array( 'jquery', 'customize-base' ), VAATHI_PLUS_VERSION, true );
		wp_enqueue_style( 'vaathi-plus-sortable-control',  VAATHI_PLUS_DIR_URL.'customizer/controls/sortable/sortable.css', null, VAATHI_PLUS_VERSION );
	}
