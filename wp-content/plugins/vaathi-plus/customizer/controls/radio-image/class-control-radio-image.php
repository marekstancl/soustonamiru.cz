...
class Vaathi_Customize_Control_Radio_Image extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'vaathi-plus-radio-image-control', VAATHI_PLUS_DIR_URL . 'customizer/controls/radio-image/radio-image.js', array( 'jquery', 'customize-base' ), VAATHI_PLUS_VERSION, true );
		wp_enqueue_style( 'vaathi-plus-radio-image-control',  VAATHI_PLUS_DIR_URL . 'customizer/controls/radio-image/radio-image.css', null, VAATHI_PLUS_VERSION );
	}
