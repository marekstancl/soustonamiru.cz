...
class Vaathi_Customize_Control_Spacing extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'vaathi-plus-spacing-control', VAATHI_PLUS_DIR_URL.'customizer/controls/spacing/spacing.js', array( 'jquery', 'customize-base' ), VAATHI_PLUS_VERSION, true );
		wp_enqueue_style( 'vaathi-plus-spacing-control',  VAATHI_PLUS_DIR_URL.'customizer/controls/spacing/spacing.css', null, VAATHI_PLUS_VERSION );
	}
