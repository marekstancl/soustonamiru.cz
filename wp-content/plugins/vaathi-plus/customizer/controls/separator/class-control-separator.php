...
class Vaathi_Customize_Control_Separator extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'vaathi-plus-separator-control',  VAATHI_PLUS_DIR_URL.'customizer/controls/separator/separator.css', null, VAATHI_PLUS_VERSION );
	}
