...
class Vaathi_Customize_Control_Responsive_Number extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'vaathi-plus-responsive-number-control', VAATHI_PLUS_DIR_URL . 'customizer/controls/responsive-number/responsive-number.js', array( 'jquery', 'customize-base' ), VAATHI_PLUS_VERSION, true );
		wp_enqueue_style( 'vaathi-plus-responsive-number-control',  VAATHI_PLUS_DIR_URL . 'customizer/controls/responsive-number/responsive-number.css', null, VAATHI_PLUS_VERSION );
	}
