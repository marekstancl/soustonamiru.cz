...
if( !class_exists( 'Vaathi_Woo_Listing_Option_Content_Element_Group' ) ) {

    class Vaathi_Woo_Listing_Option_Content_Element_Group extends Vaathi_Woo_Listing_Option_Core {
        ...
        function render_backend() {
            ...
            add_filter( 'vaathi_woo_custom_product_template_content_options', array( $this, 'woo_custom_product_template_content_options'), 50, 1 );
        }
...
if( !function_exists('vaathi_woo_listing_option_content_element_group') ) {
	function vaathi_woo_listing_option_content_element_group() {
		return Vaathi_Woo_Listing_Option_Content_Element_Group::instance();
	}
}

vaathi_woo_listing_option_content_element_group();