...
if( ! function_exists( 'vaathi_shop_woo_loop_product_content' ) ) {

	function vaathi_shop_woo_loop_product_content() {
		...
		if($product_content_enable) {
			...
			if($product_content_content) {
				...
				vaathi_shop_woo_loop_product_content_content_setup($product_content_content);
				...
				echo '<div class="product-details">';
					...
					// Others
					do_action('vaathi_woo_loop_product_content_content', 'content');
					remove_all_actions('vaathi_woo_loop_product_content_content');
	...
	add_action( 'woocommerce_shop_loop_item_title', 'vaathi_shop_woo_loop_product_content', 10 );
