...
if( !class_exists( 'Vaathi_Woo_Listing_Shop' ) ) {

    class Vaathi_Woo_Listing_Shop {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'vaathi_woo_shop_page_default_settings', $this->settings );
...
if( !function_exists('vaathi_woo_listing_shop') ) {
	function vaathi_woo_listing_shop() {
		return Vaathi_Woo_Listing_Shop::instance();
	}
}

vaathi_woo_listing_shop();