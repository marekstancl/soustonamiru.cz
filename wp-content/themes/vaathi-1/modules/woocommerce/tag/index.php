...
if( !class_exists( 'Vaathi_Woo_Listing_Tag' ) ) {

    class Vaathi_Woo_Listing_Tag {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'vaathi_woo_tag_page_default_settings', $this->settings );
...
if( !function_exists('vaathi_woo_listing_tag') ) {
	function vaathi_woo_listing_tag() {
		return Vaathi_Woo_Listing_Tag::instance();
	}
}

vaathi_woo_listing_tag();