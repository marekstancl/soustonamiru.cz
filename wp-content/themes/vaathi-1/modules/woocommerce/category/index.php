...
if( !class_exists( 'Vaathi_Woo_Listing_Category' ) ) {

    class Vaathi_Woo_Listing_Category {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( vaathi_is_file_in_theme( __FILE__ ) ) {
                    return VAATHI_MODULE_DIR . '/woocommerce/category/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( vaathi_is_file_in_theme( __FILE__ ) ) {
                    return VAATHI_MODULE_URI . '/woocommerce/category/';
                } else {
        ...
        function woo_template_redirect() {
            ...
            if( is_product_category() ) {
                ...
                /* Define Sorter Settings */
                    add_filter( 'vaathi_woo_sorter_settings', array( $this, 'woo_sorter_settings' ) );
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'vaathi_woo_category_page_default_settings', $this->settings );
        ...
        */
            function woo_load_listing() {
                ...
                if( $this->settings['product_style_template'] == 'predefined' ) {
                    $type_class_instance = 'vaathi_woo_listing_type_'.$this->settings['product_style_custom_template']; // Type Class Instance
                } else if( $this->settings['product_style_template'] == 'custom' ) {
                    $type_class_instance = 'vaathi_woo_listing_type_custom'; // Type Class Instance
                }
                ...
                if ( function_exists( $type_class_instance ) ) {
                    ...
                    if( is_array ( $type_options ) && !empty ( $type_options ) ) {
                        foreach ( $type_options as $type_option_key => $type_option ) {
                            ...
                            $option_class_instance = 'vaathi_woo_listing_option_'.$type_option_key;  // Option Class Instance
...
if( !function_exists('vaathi_woo_listing_category') ) {
	function vaathi_woo_listing_category() {
		return Vaathi_Woo_Listing_Category::instance();
	}
}

vaathi_woo_listing_category();