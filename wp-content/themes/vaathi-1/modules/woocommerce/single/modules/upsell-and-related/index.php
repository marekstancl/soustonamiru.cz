...
if( !class_exists( 'Vaathi_Shop_Single_Module_Upsell_Related' ) ) {

    class Vaathi_Shop_Single_Module_Upsell_Related {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( vaathi_is_file_in_theme( __FILE__ ) ) {
                    return VAATHI_MODULE_DIR . '/woocommerce/single/modules/upsell-and-related/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( vaathi_is_file_in_theme( __FILE__ ) ) {
                    return VAATHI_MODULE_URI . '/woocommerce/single/modules/upsell-and-related/';
                } else {
        ...
        */
            function woo_load_listing( $product_style_template, $product_style_custom_template ) {
                ...
                if( $product_style_template == 'predefined' ) {
                    $type_class_instance = 'vaathi_woo_listing_type_'.$product_style_custom_template; // Type Class Instance
...
if( !function_exists('vaathi_shop_single_module_upsell_related') ) {
	function vaathi_shop_single_module_upsell_related() {
		return Vaathi_Shop_Single_Module_Upsell_Related::instance();
	}
}

vaathi_shop_single_module_upsell_related();